...
struct ResNetBackbone : public torch::nn::Module {
    torch::nn::Sequential model;

    ResNetBackbone(bool pretrained = false) {
...
struct SimpleCrossDomainClassifier : public torch::nn::Module {
    ResNetBackbone backbone;
    torch::nn::Linear classifier;

    SimpleCrossDomainClassifier(bool pretrained = false) : backbone(pretrained), classifier(256, 10) {
...
void train_model(SimpleCrossDomainClassifier& model, torch::DataLoader& train_loader, torch::DataLoader& val_loader, int epochs, float lr) {
...
int main() {
    ...
    SimpleCrossDomainClassifier model;
